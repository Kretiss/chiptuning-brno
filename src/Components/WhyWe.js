...
const WhyWe = () =>{
  ...
  return(
    <animated.div style={spring} ref={ref}>
      ...
      <p className="moreInfo">Pro&nbsp;více informací navštivte naše mateřské stránky <a href="https://www.quantumchiptuning.cz/" target="_blank" rel="noreferrer">quantumchiptuning.cz</a></p>
    </animated.div>
